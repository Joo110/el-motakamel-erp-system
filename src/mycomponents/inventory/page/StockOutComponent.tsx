...
const StockOutComponent: React.FC = () => {
  const [products] = useState<Product[]>([
    ...
    { id: '2', name: 'Product 2', inventory: 'Abu Dhabi', code: '323-14', units: 10, price: 1710.55, discount: 13, total: 9400.0 },
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-7 gap-3 items-end">
            ...
            <div>
              ...
              <input type="text" defaultValue="96269" className="w-full px-3 py-2 border border-gray-300 rounded-full text-sm" />
            </div>
            <div className="relative">
