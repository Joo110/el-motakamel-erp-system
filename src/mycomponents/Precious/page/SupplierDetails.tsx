          ...
          <div className="flex justify-between">
            <div className="flex-1">
              <div className="flex justify-between items-start mb-6">
                <h2 className="text-xl font-bold text-gray-900">Fresh Electronics</h2>
            ...
            <div className="ml-8 flex items-center justify-center">
              <div className="text-red-500 text-4xl font-bold">⚡ FRESH</div>
            </div>
          </div>
        </div>
                  ...
                  {orders.map((order, idx) => (
                    <tr key={idx} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4">
                        <button className="text-blue-600 hover:text-blue-800 underline text-sm rounded-full">view</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
