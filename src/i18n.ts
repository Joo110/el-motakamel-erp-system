...
const resources = {
  en: {
    ...
    translation: {
      ...
      reset: "Reset",
      order_date_cannot_be_after_expected: "Order date cannot be after expected delivery date.",
...
expected_delivery_must_be_after_order: "Expected delivery date must be after order date.",
    // SupplierSearchList
    supplier_management: "Supplier Management",
    supplier_search: "Supplier Search",
    Loading_accounts: "جاري تحميل بيانات الحسابات...",
...
// en.json
  ...
  "validation_phone_invalid": "Phone number must be a valid Egyptian or Saudi mobile number",
  "validation_role_invalid": "Role must be one of: admin, employee, manager, HR, CEO, accountant, supervisor",
  "validation_alternative_phone_invalid": "Alternative phone must be a valid Egyptian or Saudi mobile number",
  "validation_email_duplicate": "Email already exists",
  "validation_cv_too_large": "CV file is too large",
  "validation_cv_type_invalid": "CV must be PDF or DOC/DOCX",
  "cv_ready_to_upload": "CV ready to upload",
  "cv_uploaded_success": "CV uploaded successfully",
...
retail_price_col	: "سعر التجزئة",
    ...
    of_orders: "من",
    Remove: "إزالة",
    product_code_already_exists: "كود المنتج موجود بالفعل",
    orders: "طلبات",
    ...
    enter_reference: "أدخل الرقم المرجعي",
...
supplier_updated_successfully: "تم تحديث المورد بنجاح!",
  ...
  duplicate_code_error: "كود المنتج مستخدم بالفعل",
  image_too_large: "حجم الصورة كبير جدًا",
  error_creating_product: "حصل خطأ أثناء إنشاء المنتج",
...
table_header_name: "الاسم",
      ...
      expected_delivery_must_be_after_order: "يجب أن يكون وقت التسليم المتوقع بعد وقت الطلب.",
      table_header_check_out: "وقت الانصراف",
      order_date_cannot_be_after_expected: "لا يمكن أن يكون تاريخ الطلب بعد وقت التسليم المتوقع.",
...
"validation_email_exists": "البريد الإلكتروني مستخدم بالفعل",
  "validation_phone_invalid": "رقم الهاتف يجب أن يكون رقم محمول مصري أو سعودي صالح",
  "validation_role_invalid": "الدور يجب أن يكون أحد: admin, employee, manager, HR, CEO, accountant, supervisor",
  "validation_alternative_phone_invalid": "رقم الهاتف البديل يجب أن يكون رقم محمول مصري أو سعودي صالح",
  "validation_email_duplicate": "البريد الإلكتروني مستخدم بالفعل",
  "validation_cv_too_large": "حجم ملف السيرة الذاتية كبير جدًا",
  "validation_cv_type_invalid": "يجب أن تكون السيرة الذاتية بصيغة PDF أو DOC/DOCX",
  "cv_ready_to_upload": "السيرة جاهزة للرفع",
  "cv_uploaded_success": "تم رفع السيرة بنجاح",
  "cv_upload_failed": "فشل رفع السيرة",

  "error_email_exists": "البريد الإلكتروني مستخدم بالفعل",
  "error_phone_exists": "رقم الهاتف مستخدم بالفعل",
  "error_national_id_exists": "الرقم القومي مستخدم بالفعل",
  "error_already_exists": "مستخدم بالفعل",
  "error_required": "مطلوب",
  "error_invalid": "غير صالح",
  "error_must_be": "يجب أن يكون",
  "error_characters": "حرف",
  "error_must_be_one_of": "يجب أن يكون أحد القيم التالية",
  "error_invalid_value": "قيمة غير صالحة",
  "error_phone_format": "يجب أن يكون رقم هاتف مصري أو سعودي صحيح",
  "error_validation": "خطأ في التحقق من البيانات",
  "error_duplicate_data": "توجد بيانات مكررة",
